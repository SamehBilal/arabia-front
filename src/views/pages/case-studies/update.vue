    ...
    <BRow>
      ...
      'is-valid': typesubmit && !v$.typeform.textarea.$error,
                  ...
                  <BRow>
                    <BCol md="6">
                      <div class="mb-3">
                        <label>Title</label>
                        <BFormInput v-model="form.state" placeholder="Stats title" :class="{
      ...
      v$.form.state.required.$message
                    ...
                    <BCol md="4">
                      <div class="mb-3">
                        <label>Stats</label>
                        <BFormInput v-model="form.url" placeholder="Stats value" :class="{
      ...
      v$.form.url.required.$message
                    ...
                    <BCol md="12">
                      <div class="mb-3">
                        <h5 class="font-size-14">Contributers</h5>
                              ...
                              <label class="card-radio-label mb-3">
                                ...
                                <div class="card-radio">
                                  ...
                                  <img src="@/assets/images/product/img-2.png" alt
                                    class="align-middle me-2 btn-rounded avatar-sm" />
                                  <span>Rima</span>
                                </div>
                              </label>
                            </div>
