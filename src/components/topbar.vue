  ...
  <header id="page-topbar">
    <div class="navbar-header">
      ...
      <div class="d-flex">
        ...
        <BDropdown variant="white" class="d-none d-lg-inline-block d-lg-inline-block ms-1" menu-class="dropdown-menu-lg dropdown-menu-end" right toggle-class="header-item noti-icon" size="md">
        ...
        <!-- <div class="dropdown d-inline-block">
          <button type="button" class="btn header-item noti-icon right-bar-toggle waves-effect toggle-right" @click="changemode()">
            <i :class="[darkMode ? 'ri-sun-line' : 'ri-moon-clear-line',]"></i>
          </button>
        </div> -->
        ...
        <div class="dropdown d-inline-block">
          <button type="button" class="btn header-item noti-icon right-bar-toggle waves-effect toggle-right" @click="toggleRightSidebar()">
            <i class="toggle-right ri-settings-line"></i>
          </button>
        </div>
      </div>
    </div>
